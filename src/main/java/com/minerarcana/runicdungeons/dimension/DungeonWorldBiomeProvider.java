...
public class DungeonWorldBiomeProvider extends BiomeProvider {
    private static final List<Biome> SPAWN = Collections.singletonList(Biomes.END_BARRENS);
    private final Biome biome;

    public DungeonWorldBiomeProvider(SingleBiomeProviderSettings settings) {

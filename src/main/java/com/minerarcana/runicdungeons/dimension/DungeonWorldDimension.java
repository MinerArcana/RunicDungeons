...
public class DungeonWorldDimension extends Dimension {
    ...
    public ChunkGenerator<?> createChunkGenerator() {
        return RunicDungeonDimension.generatorType.create(this.world, RunicDungeonDimension.biomeProviderType.create(RunicDungeonDimension.biomeProviderType.createSettings().setBiome(Biomes.PLAINS)), RunicDungeonDimension.generatorType.createSettings());
    }
